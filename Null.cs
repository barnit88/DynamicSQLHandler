...
namespace DynamixSQLHandler
{
    ...
    public class Null
    {
        ...
        /// Returns -1.
        /// </summary>
        public static short NullShort { get { return -1; } }


        /// <summary>
        /// Return -1.
        /// </summary>
        public static int NullInteger { get { return -1; } }


        /// <summary>
        /// Return float MinValue.
        /// </summary>
        public static float NullSingle { get { return float.MinValue; } }

        /// <summary>
        /// Return double MinValue.
        /// </summary>
        public static double NullDouble { get { return double.MinValue; } }
        ...
        /// </summary>
        public static System.DateTime NullDate { get { return System.DateTime.MinValue; } }

        /// <summary>
        /// Return empty string.
        /// </summary>
        public static string NullString { get { return ""; } }

        /// <summary>
        /// Return false.
        /// </summary>
        public static bool NullBoolean { get { return false; } }

        /// <summary>
        /// Return empty Guid.
        /// </summary>
        public static Guid NullGuid { get { return Guid.Empty; } }
        ...
        public static object SetNull(object objValue, object objField)
        {
            ...
            {
                if (objField is short) functionReturnValue = NullShort;
                else if (objField is int) functionReturnValue = NullInteger;
                else if (objField is float) functionReturnValue = NullSingle;
                else if (objField is double) functionReturnValue = NullDouble;
                else if (objField is decimal) functionReturnValue = NullDecimal;
                else if (objField is DateTime) functionReturnValue = NullDate;
                else if (objField is string) functionReturnValue = NullString;
                else if (objField is bool) functionReturnValue = NullBoolean;
                else if (objField is Guid) functionReturnValue = NullGuid;
                else functionReturnValue = null; // complex object
            }
            else
        ...
        public static object SetNull(PropertyInfo objPropertyInfo)
        {
            ...
            {
                case "System.Int16": functionReturnValue = NullShort; break;
                case "System.Int32":
                case "System.Int64":
                    functionReturnValue = NullInteger;
                    break;
                case "System.Single": functionReturnValue = NullSingle; break;
                case "System.Double": functionReturnValue = NullDouble; break;
                case "System.Decimal": functionReturnValue = NullDecimal; break;
                case "System.DateTime": functionReturnValue = NullDate; break;
                case "System.String":
                case "System.Char":
                    functionReturnValue = NullString;
                    break;
                case "System.Boolean": functionReturnValue = NullBoolean; break;
                case "System.Guid": functionReturnValue = NullGuid; break;

                default:

                    if (objPropertyInfo.PropertyType.IsClass || objPropertyInfo.PropertyType.IsInterface)
                        break;
